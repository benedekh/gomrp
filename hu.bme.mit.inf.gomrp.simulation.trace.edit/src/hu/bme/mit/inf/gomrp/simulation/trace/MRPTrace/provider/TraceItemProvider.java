...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.inf.gomrp.simulation.trace.MRPTrace.Trace} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TraceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trace_granularity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trace_granularity_feature", "_UI_Trace_type"),
				 MRPTracePackage.Literals.TRACE__GRANULARITY,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MRPTracePackage.Literals.TRACE__CONSISTS_OF);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MRPTracePackage.Literals.TRACE__CONSISTS_OF,
				 MRPTraceFactory.eINSTANCE.createTraceEntry()));
	}
