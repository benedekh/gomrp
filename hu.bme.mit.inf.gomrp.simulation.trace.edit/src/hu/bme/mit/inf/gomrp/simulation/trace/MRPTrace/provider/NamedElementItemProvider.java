...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.inf.gomrp.simulation.trace.MRPTrace.NamedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamedElementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MRPTracePackage.Literals.NAMED_ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NamedElement.class)) {
			case MRPTracePackage.NAMED_ELEMENT__NAME:
