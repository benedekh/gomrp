 ...
 * <ul>
 *   <li>{@link hu.bme.mit.inf.gomrp.statemachine.StateMachine.impl.CompositeStateImpl#getStatemachine <em>Statemachine</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompositeStateImpl extends StateImpl implements CompositeState {
	...
	public NotificationChain basicSetStatemachine(StateMachine newStatemachine, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StateMachinePackage.COMPOSITE_STATE__STATEMACHINE, oldStatemachine, newStatemachine);
	...
	public void setStatemachine(StateMachine newStatemachine) {
		if (newStatemachine != statemachine) {
			...
			if (statemachine != null)
				msgs = ((InternalEObject)statemachine).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StateMachinePackage.COMPOSITE_STATE__STATEMACHINE, null, msgs);
			if (newStatemachine != null)
				msgs = ((InternalEObject)newStatemachine).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StateMachinePackage.COMPOSITE_STATE__STATEMACHINE, null, msgs);
			msgs = basicSetStatemachine(newStatemachine, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StateMachinePackage.COMPOSITE_STATE__STATEMACHINE, newStatemachine, newStatemachine));
	}
