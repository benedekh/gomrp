...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.inf.gomrp.simulation.traceability.MRPTraceability.ModifieredElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModifieredElementItemProvider 
	 ...
	 * @generated
	 */
	public ModifieredElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		Modifier labelValue = ((ModifieredElement)object).getModifier();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ModifieredElement_type") :
			getString("_UI_ModifieredElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ModifieredElement.class)) {
