...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.inf.gomrp.statemachine.StateMachine.ActionExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionExpressionItemProvider extends ActionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActionExpression_expression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ActionExpression_expression_feature", "_UI_ActionExpression_type"),
				 StateMachinePackage.Literals.ACTION_EXPRESSION__EXPRESSION,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ActionExpression.class)) {
			case StateMachinePackage.ACTION_EXPRESSION__EXPRESSION:
