...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.inf.gomrp.statemachine.StateMachine.GuardExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GuardExpressionItemProvider extends GuardItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StateMachinePackage.Literals.GUARD_EXPRESSION__EXPRESSION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((GuardExpression)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GuardExpression_type") :
			getString("_UI_GuardExpression_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GuardExpression.class)) {
			case StateMachinePackage.GUARD_EXPRESSION__EXPRESSION:
