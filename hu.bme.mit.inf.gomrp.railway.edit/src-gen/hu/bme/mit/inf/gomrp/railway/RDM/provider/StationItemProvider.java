...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.inf.gomrp.railway.RDM.Station} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StationItemProvider extends SectionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Station_controls_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Station_controls_feature", "_UI_Station_type"),
				 RDMPackage.Literals.STATION__CONTROLS,
				 false,
				 false,
				 false,
				 null,
