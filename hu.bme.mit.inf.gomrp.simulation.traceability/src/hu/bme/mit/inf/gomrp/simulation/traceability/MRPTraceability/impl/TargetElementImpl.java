 ...
 * <ul>
 *   <li>{@link hu.bme.mit.inf.gomrp.simulation.traceability.MRPTraceability.impl.TargetElementImpl#getSource <em>Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class TargetElementImpl extends NamedElementImpl implements TargetElement {
	/**
	...
	protected EClass eStaticClass() {
		return MRPTraceabilityPackage.Literals.TARGET_ELEMENT;
	}
	...
	public EList<SourceElement> getSource() {
		if (source == null) {
			source = new EObjectWithInverseResolvingEList.ManyInverse<SourceElement>(SourceElement.class, this, MRPTraceabilityPackage.TARGET_ELEMENT__SOURCE, MRPTraceabilityPackage.SOURCE_ELEMENT__TARGET);
		}
		return source;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MRPTraceabilityPackage.TARGET_ELEMENT__SOURCE:
