 ...
 * <ul>
 *   <li>{@link hu.bme.mit.inf.gomrp.simulation.traceability.MRPTraceability.impl.TypedElementImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TypedElementImpl extends MinimalEObjectImpl.Container implements TypedElement {
	...
	protected EClass eStaticClass() {
		return MRPTraceabilityPackage.Literals.TYPED_ELEMENT;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MRPTraceabilityPackage.TYPED_ELEMENT__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MRPTraceabilityPackage.TYPED_ELEMENT__TYPE:
				return getType();
		}
